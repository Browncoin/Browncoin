...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x000006ddb41873f4df27882c7bc1800b146972f8629d95300f9fd6b93ca59672");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Browncoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Browncoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000006ddb41873f4df27882c7bc1800b146972f8629d95300f9fd6b93ca59672");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BrowncoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BrowncoinCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BrowncoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Browncoin-miner");
    ...
    try { loop {
        ...
        printf("Running BrowncoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BrowncoinMiner terminated\n");
        throw;
    }
}
